...
C̘̰̩̣̠̬̀ͥͦ̆O̭͕͖̍M̘̱͊͒͗͆ͨ̚͟M͇̮A̫͔ͧ̒̄̑ͫ̀̀Ṅ̹̦̜̪̫͐̎͒ͨ͐͆D̯̞̖̼͙̭͋̑̿̀ͥ ̵̽̀̌ͣ͂̃G̰̳̞͚̭͉̣̓͆ͤR̷͈͓̪̫̲͈ͬͭOͣͩ̎҉͉U̝͌̑̄̊̓́B̡̪͍̯̘̳̣̙ͬ
=> Set group
=> Gn namagroup
=> Open url
=> Close url
...
C̹̬̰̳ͭ͆̓͗̽O͓̬͈̽͗̆ͭͥͧMͮ̚M̞͖̾ͧͩ͋̌̈́A͕̖̭̫ͥ̌̋̂̚ͅN͖͎̞̠͚̓̽D̜̤̤̼̤͙̗͗̊ ͎̹̳̅͂̆̄Ċ̟̲̞͇̟̭ͯ̓ͩR̦Ë͖̟̥́͂ͪ̚A̩̓̊T͓͉͙͌͑͊̈ͩ̑Ö͇̘̠́ͦ̿ͧ̚R̗̗̻̻͔͈͉
=> Admin add @ (By Tag)
=> Admin remove @(By Tag)
=> Adminlist 
=> InviteMeTo:
...
M͖̱̒̌̍̑I̺̠̩̖̝ͧ̔͗̚͢ͅM̡̱̍ͪȊ͚̼̖̣̟͗͑ͣ̎ͪC͙̹͚ͩ̏ͧ̆̒̋ ̜͔C͎̗̫͆̾͛ͬ͂͛̈́͜ͅO̱̲̜͇͛̾M͈̫͐͋͐͂́̓M͉̝̹͈̖Ā̤͓̐̌̔̏ͮ͞Ñ̴̘̤̲͚̯̟ͬ͋Ḑ̍
=> Mimic @ (By Tag)
=> Mimic:add: @ (By Tag)
=> Mimic:del: @ (By Tag)
=> ListTarget

C͙ͣͧ̃̎̾̕O̧̱͈̺͚̯̱ͅM̅ͮ͞M͇̯̑̊͂ͣ̑̊ͤA͚̞͔͚͉̓N̙̝̝̯̞̱̑̒ͫͮ͂͗̕D̢̳͚͖̣̜ͫͫ͗͌̌ ̹̹͚̙̄̎̈̽̒ͅP̢̫̱̼̺̳̈̔̒Ȓ̷͚͎̺͑̒̑O͕͙̹̝̔̌ͩ̌T̵̬͉̮̥͖͍̈̓ͬ̀̇ͦͥE͙͙͠ͅC̈́ͮͥT̫̪͉̥̥̹̖̽͆̾͋̒͂̑
=> Gr on/off
=> Contact on/off
=> Cancl on/off
=> Joinn on/off
...
admin=["uddb6b470ab4b54c5fbc69d7600cc3bc81"]
owner=["uddb6b470ab4b54c5fbc69d7600cc3bc8"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Owner line.me/ti/p/~babydino20",
    "lang":"JP",
    "comment":"Owner line.me/ti/p/~babydino20",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
    try:
		...
		if op.type == 15:
			random.choice(KAC).sendText(op.param1, "Dadah (*._.*).")
        ...
        if op.type == 17:
            ...
            cb = Message()
            cb.to = op.param1
            cb.text = "Hay " + cl.getContact(op.param2).displayName + ", Selamat datang di " + group.name
            cl.sendMessage(cb)
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uec13f3c18fd696fe7c2ffd4c7e001a31":
                    if "join:" in msg.text:
        ...
        if op.type == 26:
	       ...
	       if msg.from_ in admin:
            ...
            elif "itachi kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_second kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Obito kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_third kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Daidara kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "Obito " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("tinvite ","")
                kk.findAndAddContactsByMid(midd)
                kk.inviteIntoGroup(msg.to,[midd])
            elif "Daidara " in msg.text:
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Owner by PANCY")
	       ...
	       if msg.from_ in admin:
            ...
            elif msg.text in ["Pain cancel","Bot cancel"]:
                if msg.toType == 2:
         ...
         #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in Bots:
                if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"Kami di perintahkan untuk menghancurkan grub ini")
                    kk.sendText(msg.to,"Grub akan rata dalam beberapa detik..")
                    kc.sendText(msg.to,"sebelum rata izinkan saya promo wkwk , jasa Deff groub pc owner line.me/ti/p/~babydino20")
                    msg.contentType = 13
                    msg.contentMetadata = {'uddb6b470ab4b54c5fbc69d7600cc3bc8': mid}
                    cl.sendMessage(msg)
                    targets = []
                    for s in gs.members:
...
#------------------------------------------------
       ...
       #--------------Fungsi Broadcast Finish-----------#
                ...
                ki.sendText(msg.to,"Hay")
                kk.sendText(msg.to,"Hay")
                kc.sendText(msg.to,"Hay")
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
			...
			cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by line.me/ti/p/~babydino20")
