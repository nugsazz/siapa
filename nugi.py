...
cl = LINETCR.LINE()
cl.login(token="EmkUf7RQk8z7JrAO8Pw7.fROoCb5YL8J4cs3OuFFzjW.8SJvB2Cp3I2KF3OMrkUuNQ7x4YqYITefu2UclPfa208=")
cl.loginResult()
#ki = LINETCR.LINE()
#ki.login(qr=True)
#ki.loginResult()
    ...
    try:
        ...
        if op.type == 26:
	       ...
	       if msg.from_ in admin:
            ...
            elif "Origami kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_second kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Tohka kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "Origami " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Tohka " in msg.text:
              if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                msg.contentMetadata = {'mid': 'uddb6b470ab4b54c5fbc69d7600cc3bc81'}
                cl.sendMessage(msg)
            elif msg.text in ["Me"]:
                msg.contentType = 13
